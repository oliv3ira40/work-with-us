...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-box">
                <h4 class="m-t-0 header-title">Edição de vaga</h4>
                {!! Form::model($job, ['url'=>route('adm.job_opportunities.update')]) !!}
                    {!! Form::hidden('id', $job->id) !!}
                    {!! Form::hidden('job_city_id', $job->city_id, ['id' => 'job_city_id']) !!}

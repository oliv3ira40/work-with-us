...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-box">
                <h4 class="m-t-0 header-title">Excluindo usuário definitivamente</h4>
                <p class="text-muted font-14 m-b-30">
                    Essa é uma exclusão permanente e não pode ser revertida
                </p>

                {!! Form::model($user, ['url'=>route('adm.users.definitive_exclusion')]) !!}
                    {!! Form::hidden('id', null) !!}

...
@section('title', 'Nova meio de divulgação da vaga')
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-box">
                <h4 class="m-t-0 header-title">Nova meio de divulgação da vaga</h4>
                {!! Form::open(['url'=>route('adm.mean_of_publ_vag.save')]) !!}
                    <div class="form-row">
